...
import { buildRarefactionSaturationGeometry } from '../../../geometry/rarefactionSaturationGeometry'
import { ZCompactifiedMesh } from '../../../app/scene/ZCompactification'

function RarefactionSaturationSurface({
  fixedState,
  params,
  view,
  resolution,
  ...
  const geometry = useMemo(() => {
    ...
    return buildRarefactionSaturationGeometry({ fixedState, params, view, resolution, direction })
...
export function RarefactionSaturationSlowSurface(props) {
  return (
    <RarefactionSaturationSurface
      {...props}
      direction={FORWARD_HUGONIOT}
...
export function RarefactionSaturationFastSurface(props) {
  return (
    <RarefactionSaturationSurface
      {...props}
...
export default RarefactionSaturationSurface
