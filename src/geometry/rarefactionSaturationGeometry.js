...
function normalizedPointDistance(a, b, view) {
  ...
  return Math.hypot((a.t - b.t) / tauScale, (a.Y - b.Y) / yScale, dz)
}
...
export function buildRarefactionSaturationGeometry({ fixedState, params, view, resolution = 40, direction = FORWARD_HUGONIOT }) {
